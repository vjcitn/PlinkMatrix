...
rownames(gdemo) = gsub("0_", "", rownames(gdemo))
gdemo
```
...
We can use the Bioconductor pattern of "rows are features,
columns are samples" with a transposed PlinkMatrix.

```{r lkra}
data(example_GRanges)
library(SummarizedExperiment)
nse = SummarizedExperiment(list(genotypes=t(gdemo)), 
